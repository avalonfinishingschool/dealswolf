# RailsAdmin config file. Generated on December 22, 2013 15:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Dreamdeal', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Currency', 'Plan', 'Type', 'User']

  # Include specific models (exclude the others):
  config.included_models = ['Currency', 'Plan', 'Type', 'User', 'Team', 'Deal', 'Visibility']
  ...
  #     configure :number_users, :integer 
